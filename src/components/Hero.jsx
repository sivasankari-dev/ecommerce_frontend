...
const Hero = () => {
  return (
    <div
      className="h-svh bg-cover bg-no-repeat flex items-center justify-end text-white bg-[url('./assets/shoppro_hero.jpg')]"
    ...
    >
      <div className='flex flex-col items-center justify-center mr-5'>
        ...
        <a href="#shop" className="bg-black hover:bg-sky-900 text-white font-semibold px-6 py-3 rounded-lg transition duration-300">
          Start Shopping →
        </a>
      </div>
   </div>
